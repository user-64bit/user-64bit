...
<p align="center">
  <i>A living index of what I'm shipping. <code>🟢</code> = live · <code>📦</code> = published · <code>—</code> = source-only</i>
</p>
...
| Project | What it does | Stack | Live | Repo |
|---|---|---|---|---|
| **DevDNA** | Cinematic GitHub profile analyzer — generates an animated developer identity report | Next.js · TS · Tailwind · framer-motion | 🟢 [dev-dna-theta.vercel.app](https://dev-dna-theta.vercel.app) | [↗](https://github.com/user-64bit/dev-dna) |
| **DD-Agent** | AI health agent inspired by Bryan Johnson's *Don't Die* blueprint — chat + structured longevity plans | Next.js · OpenAI · TS · Tailwind | 🟢 [dd-agent-ruby.vercel.app](https://dd-agent-ruby.vercel.app) | [↗](https://github.com/user-64bit/dd-agent) |
| **Legal Sahayak** | MCP server for Indian legal assistance — Puch AI / Claude compatible | Python · MCP · FastAPI | — | [↗](https://github.com/user-64bit/legal-sahayak-mcp) |
| **RAG-PDF** | Django API to upload PDFs and ask cited questions over their contents | Django · ChromaDB · OpenAI | — | [↗](https://github.com/user-64bit/rag-pdf) |
